export const projects = [
  ...
  },
  {
    name: "REST Countries",
    description: {
      es: "App web que permite visualizar países obtenidos mediante la API de RestCountries. Permite filtrar los países y obtener más detalles en una página individual.",
      en: "Web app that allows viewing countries obtained through the RestCountries API. It allows filtering countries and getting more details on an individual page."
    },
  ...
  },
  {
    name: "Readmydoc",
    description: {
      es: "Aplicación web para la edición de Markdown para proyectos de software, permitiendo elegir entre diferentes plantillas predefinidas, además de exportar el documento en formato .md",
      en: "Web application for editing Markdown for software projects, allowing users to choose from different predefined templates and export the document in .md format."
    },
    technologies: ["NextJS", "Monaco Editor", "Zustand", "TailwindCSS"],
